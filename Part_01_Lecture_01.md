Here are the presentations for **Hour 1** and **Hour 2** reformatted into the clean, presentation-ready Markdown format to match the rest of your course!
...
```markdown
# Hour 1: Your First Lines of JavaScript
